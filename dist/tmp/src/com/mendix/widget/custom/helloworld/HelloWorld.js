...
class HelloWorldContainer extends React.Component {
    ...
    render() {
        return (React.createElement(Hello_1.Hello, { style: this.props.style, className: this.props.class ? this.props.class : undefined, message: this.state.displayMessage, attributeMessage: this.state.messageAttribute }));
    }
}
...
const HelloWorldContainer_1 = __webpack_require__(0);
exports.Hello = (props) => (React.createElement("div", { className: `${props.className}`.trim(), style: HelloWorldContainer_1.default.parseStyle(props.style) },
