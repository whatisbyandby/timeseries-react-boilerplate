...
const Hello_1 = __webpack_require__(10);
class HelloWorldContainer extends React.Component {
    ...
    updateState(mxObject = this.props.mxObject) {
        return {
    ...
    getAttributeValue(attribute, mxObject) {
        if (mxObject && attribute) {
            return mxObject.get(attribute);
        }
        return "";
    }
    render() {
        return (React.createElement(Hello_1.Hello, { message: this.state.displayMessage, attributeMessage: this.state.messageAttribute }));
    }
}
exports.default = HelloWorldContainer;
...
exports.Hello = (props) => (React.createElement("div", { className: "main-div" },
    React.createElement("h1", null, props.message),
    React.createElement("h3", null, props.attributeMessage)));
